...
namespace ExemploApiCatalogoJogos.Controllers.API.v1
{
    ...
    public class JogosController : ControllerBase
    {
        ...
        [HttpGet]
        public async Task<ActionResult<IEnumerable<JogoViewModel>>> Obter([FromQuery, Range(1, int.MaxValue)] int pagina = 1, [FromQuery, Range(1, 50)] int quantidade = 100)
        {
